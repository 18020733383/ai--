...
内容安全要求（非常重要）：
- 用词必须委婉、PG-13，不要出现血腥/肢解/尸体/虐待/性暗示/裸露/毒品/仇恨/极端主义等内容
- 如果兵种名称或设定可能引发敏感词，请用中性表达替换（例如“战损”而不是“血肉横飞”，“阴影与尘土”而不是“血迹”）
- 不要写“杀戮、屠杀、斩首、开膛、血浆、残肢、尸体、内脏”等词；不要写“裸、乳、性交”等词
  ...
  "items": [
    {
      ...
      "imagePrompt": "给生图模型的最终 prompt（建议英文，包含风格与限制与安全要求，避免敏感词）"
    }
  ]
}
  `.trim();
