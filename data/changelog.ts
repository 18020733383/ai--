...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-04-04',
    items: [
      '兵种新增「作战职能」多层标签（如枪骑突刺、战阵法师、空中强袭等三十余类），写入模板并用于兵种卡/档案检索',
      '默认同阵位分层优先参考职能标签，缺省时仍回退原文关键词'
    ]
  },
  {
    version: '0.13.13',
    date: '2026-04-04',
    items: [
      '王国战略：意向变更时记入 lastShift 纪要；关系页展示外交辞令摘要、重审倒计时、上次更迭说明与可折叠密档数值表；可关「流言入日志」',
      '大地图：可选「战略目光」极淡矢量（势力几何中心→焦点据点）与悬浮标签「战略目光」',
      '日结：战略重定向时低概率向世界日志推送酒馆式流言（受上述开关控制）'
    ]
  },
  {
    version: '0.13.12',
  ...
  },
  {
    ...
    date: '2026-04-03',
    items: [
      '城内打工委托：按势力与城市生成不同标题池；商业等级提高更易出现高星委托',
      '特殊委托：完成可得角色经验或势力风味援军，另有按比例的商业津贴；过半中止仅津贴按约五分之一结算',
      '委托榜「今日刷新」每日每城一次，与自动每三日补榜并存；大地图进行中的报酬摘要同步显示',
      '新增多项委托相关跨存档成就（入门、累计、特殊报酬、刷新、五星、三城）'
    ]
  },
  {
    version: '0.13.7',
  ...
  },
  {
    ...
    date: '2026-04-03',
    items: [
      '新兵种三线：狂热信徒可分支「灰烬审问官→炽焰高阶忏罪者→终焉绯色裁断王」',
      '「星坠宣誓者→彗尾侍从→蚀骑突骑长→虚界边缘圣骑→天枢御极星骑士」帝国星骑升级树',
      '哥布林「发条跃行者→锅炉壮绿皮→废铁收割机→锈铸绿皮巨偶（重型）」',
      '志愿兵与城/堡雇佣池、重型试炼场已接入相应招募条目'
    ]
  },
  {
    version: '0.13.5',
    date: '2026-04-03',
    items: [
      '角色界面新增「虚无刻印」：中二共鸣随实战胜负涨落；可消耗共鸣立下「真名誓约」使下一战全体略增攻击与士气',
      '每日一次的「命运宣告」：随机六面命运，影响金币、声望与共鸣，并写入事件日志',
      '新增配套中二风味战报台词与两项成就（共鸣超限 / 真名债主）'
    ]
  },
  {
    version: '0.13.4',
    date: '2026-03-25',
    items: [
      '兵种档案升级树：修复因容器尺寸变化反复重置视图导致的平移/缩放异常；滚轮改为在画布上监听并用函数式更新缩放；拖拽使用当前变换引用',
      '新增亡灵空中升级线（尸腐鳞蛾→蚀月收割者）、亡灵重型线（坟丘巨儡→圣堂陨落巨像）、魔导空中分支（滑翔翼可分支至天穹撞角舰）、攻城塔楼车等',
      '墓园招募与重型试炼场、城邦驻军随机池接入上述新兵种',
      '跨存档成就系统（localStorage）：达成时顶部弹窗提示；主菜单「成就」分页可按类别筛选',
      '战斗胜利/训练胜利、天数与金币声望阈值、进入大地图与兵种档案、手动存档、观看结局等会解锁对应成就'
    ]
  },
  {
    version: '0.13.3',
    date: '2026-03-16',
    items: [
      '大地图：据点图标统一为同一像素尺寸（含 emoji 类据点）；内边距统一',
      '大地图：队伍移动速度 1.5 倍；滚轮缩放去掉 zoom/camera 的舍入与地图 translate 的十分位取整，减轻缩放抖动',
      '大地图：「定位队伍」镜头平滑移向玩家（ cubic ease-out ），拖拽或滚轮会取消插值',
