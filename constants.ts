...
const RAW_TROOP_TEMPLATES: Record<string, Omit<Troop, 'count' | 'xp'>> = {
  ...
  militia: {
    ...
    upgradeTargetIds: ['footman', 'archer', 'cavalryman', 'arcane_apprentice'],
  ...
  arcane_apprentice: {
    ...
    upgradeCost: 90,
    maxXp: 60,
    upgradeTargetIds: ['pyro_acolyte', 'necro_apprentice', 'shadow_adept', 'glitch_weaver'],
    description: '以算力驱动法术的新人。【技能：计算共鸣】施法单位越多，远程伤害略增。',
    equipment: ['简易法杖', '符纸', '布袍'],
    attributes: troopAttr(55, 40, 60, 50, 90, 65)
  },
  pyro_acolyte: {
    id: 'pyro_acolyte',
    name: '火焰侍法者',
    ...
    upgradeCost: 180,
    maxXp: 140,
    upgradeTargetId: 'flame_invoker',
    description: '利用系统漏洞改写环境变量，点燃火焰推进。【技能：燃烧帧】持续灼烧前排。',
    equipment: ['火纹法杖', '抗热披风'],
    attributes: troopAttr(80, 45, 65, 70, 120, 70)
  },
  flame_invoker: {
    id: 'flame_invoker',
    name: '烈焰塑形者',
    ...
    upgradeCost: 320,
    maxXp: 220,
    upgradeTargetId: 'inferno_archmage',
    description: '将火焰塑成推进的壁垒。【技能：炽壁】远程伤害提升并削弱敌近战冲击。',
    equipment: ['燃核法杖', '炽火符链'],
    attributes: troopAttr(110, 60, 70, 90, 150, 75)
  },
  inferno_archmage: {
    id: 'inferno_archmage',
    name: '焚界大法师',
    ...
    upgradeCost: 0,
    maxXp: 420,
    description: '以算力重写战场温度曲线。【技能：焚界】大范围燃烧并造成持续压制。',
    equipment: ['熔核权杖', '熔火披风'],
    attributes: troopAttr(140, 75, 80, 110, 185, 80)
  },
  necro_apprentice: {
    id: 'necro_apprentice',
    name: '亡灵学徒',
    ...
    upgradeCost: 170,
    maxXp: 140,
    upgradeTargetId: 'bone_binder',
    description: '欺骗系统唤醒死亡进程并注入活动脚本。【技能：幽契】阵亡时召回少量战斗力。',
    equipment: ['骸骨法杖', '死印戒'],
    attributes: troopAttr(75, 50, 55, 80, 110, 65)
  },
  bone_binder: {
    id: 'bone_binder',
    name: '骨仪束缚者',
    ...
    upgradeCost: 310,
    maxXp: 210,
    upgradeTargetId: 'grave_lord',
    description: '以骨阵操控亡者脚本。【技能：骨潮】近战冲击降低，己方耐久提升。',
    equipment: ['骨仪权杖', '亡灵披巾'],
    attributes: troopAttr(95, 70, 55, 120, 120, 70)
  },
  grave_lord: {
    id: 'grave_lord',
    name: '墓域主宰',
    ...
    upgradeCost: 0,
    maxXp: 380,
    description: '命令死者执行重写后的战斗脚本。【技能：墓域】战场持续吸取生命。',
    equipment: ['冥骨冠', '亡者权杖'],
    attributes: troopAttr(120, 90, 55, 150, 135, 75)
  },
  shadow_adept: {
    id: 'shadow_adept',
    name: '暗影行者',
    ...
    upgradeCost: 190,
    maxXp: 150,
    upgradeTargetId: 'shadow_assassin',
    description: '干扰客户端视野，制造短暂盲区。【技能：影障】敌军命中率降低。',
    equipment: ['影匕', '遮蔽披风'],
    attributes: troopAttr(85, 45, 85, 65, 95, 75)
  },
  shadow_assassin: {
    id: 'shadow_assassin',
    name: '暗影刺客',
    ...
    upgradeCost: 330,
    maxXp: 230,
    upgradeTargetId: 'night_reaver',
    description: '潜入敌阵切断关键链路。【技能：静默切片】对远程单位造成额外打击。',
    equipment: ['裂影双刃', '夜行罩衣'],
    attributes: troopAttr(115, 60, 105, 80, 110, 80)
  },
  night_reaver: {
    id: 'night_reaver',
    name: '夜幕裂行者',
    ...
    upgradeCost: 0,
    maxXp: 420,
    description: '以短时高算力封锁视野。【技能：黑域】敌军士气持续下降。',
    equipment: ['夜幕刃', '影核披风'],
    attributes: troopAttr(140, 70, 125, 95, 120, 90)
  },
  glitch_weaver: {
    id: 'glitch_weaver',
    name: '异常编织者',
    ...
    upgradeCost: 185,
    maxXp: 150,
    upgradeTargetId: 'anomaly_savant',
    description: '用法术操控系统异常节点。【技能：错码】削弱敌军远程火力。',
    equipment: ['错码法杖', '数据披风'],
    attributes: troopAttr(80, 50, 70, 70, 115, 70)
  },
  anomaly_savant: {
    id: 'anomaly_savant',
    name: '异常智者',
    ...
    upgradeCost: 320,
    maxXp: 220,
    upgradeTargetId: 'kernel_oracle',
    description: '牵引异常流转，重塑战场逻辑。【技能：异常回路】增强己方远程压制。',
    equipment: ['异常权杖', '编码仪轨'],
    attributes: troopAttr(105, 65, 75, 95, 150, 75)
  },
  kernel_oracle: {
    id: 'kernel_oracle',
    name: '内核预言者',
  ...
  undead_bone_rider: {
    ...
    upgradeCost: 140,
    maxXp: 95,
    upgradeTargetId: 'undead_bone_hussar',
    description: '骑在骨马上疾驰的亡者。【技能：碎步冲刺】短时间提高机动。',
    equipment: ['骨刃马刀', '骨马', '破甲护片'],
    attributes: troopAttr(5, 4, 6, 5, 2, 6)
  },
  undead_bone_hussar: {
    id: 'undead_bone_hussar',
    name: '白骨骠骑',
    tier: TroopTier.TIER_3,
    basePower: 60,
    cost: 260,
    upgradeCost: 420,
    maxXp: 200,
    upgradeTargetId: 'undead_wight_knight',
    description: '更凶悍的冲锋手。【技能：穿阵】第一回合对轻甲造成额外伤害。',
    equipment: ['骨枪', '骨马', '骨片甲'],
    attributes: troopAttr(6, 5, 7, 6, 2, 7)
  },
  undead_wight_knight: {
    id: 'undead_wight_knight',
    name: '尸妖骑士',
    tier: TroopTier.TIER_4,
    basePower: 105,
    cost: 680,
    upgradeCost: 980,
    maxXp: 650,
    upgradeTargetId: 'undead_dread_marshal',
    description: '披着冥霜的骑士。【技能：冥霜践踏】降低敌军攻速与命中。',
    equipment: ['冥霜长枪', '幽骑战马', '黑铁骨甲'],
    attributes: troopAttr(8, 7, 6, 8, 2, 8)
  },
  undead_dread_marshal: {
    id: 'undead_dread_marshal',
    name: '恐惧统领',
    tier: TroopTier.TIER_5,
    basePower: 185,
    cost: 1900,
    upgradeCost: 0,
    maxXp: 3500,
    description: '将恐惧当作军令的统帅。【连携：冥夜军令】亡灵单位士气与防御提升。',
    equipment: ['死誓战槌', '黑骑战马', '统领骨旗'],
    attributes: troopAttr(9, 8, 6, 9, 2, 10)
  },
  undead_grave_alchemist: {
    id: 'undead_grave_alchemist',
    name: '尸油炼金师',
    tier: TroopTier.TIER_3,
    basePower: 52,
    cost: 230,
    upgradeCost: 450,
    maxXp: 220,
    upgradeTargetId: 'undead_plague_doctor',
    description: '调配尸油与骨粉的亡者。【技能：腐蚀瓶】削弱目标护甲与命中。',
    equipment: ['尸油瓶', '骨粉囊', '破布护袍'],
    attributes: troopAttr(5, 3, 5, 5, 6, 7)
  },
  undead_plague_doctor: {
    id: 'undead_plague_doctor',
    name: '瘟疫医师',
    tier: TroopTier.TIER_4,
    basePower: 92,
    cost: 640,
    upgradeCost: 980,
    maxXp: 700,
    upgradeTargetId: 'undead_pestilence_lord',
    description: '瘟疫像披风一样跟着他。【技能：疫潮】持续削弱敌军防御并造成流血。',
    equipment: ['鸟嘴面具', '瘟疫药剂', '疫雾披风'],
    attributes: troopAttr(7, 5, 5, 7, 7, 8)
  },
  undead_pestilence_lord: {
    id: 'undead_pestilence_lord',
    name: '腐疫领主',
    tier: TroopTier.TIER_5,
    basePower: 190,
    cost: 2100,
    upgradeCost: 0,
    maxXp: 4000,
    description: '把瘟疫当作王权的亡者。【连携：疫海】战场上敌军士气持续下降。',
    equipment: ['疫王权杖', '黑雾披风', '腐疫冠冕'],
    attributes: troopAttr(9, 6, 5, 8, 8, 9)
  },
  undead_bone_mortar: {
    id: 'undead_bone_mortar',
    name: '白骨迫击炮',
    race: 'UNDEAD',
    tier: TroopTier.TIER_4,
    basePower: 150,
    ...
    upgradeCost: 0,
    maxXp: 2000,
    description: '用骨架与尸油驱动的抛射器。【技能：骨爆弹】对密集阵线造成极高伤害。',
    equipment: ['骨爆弹', '骨架炮架', '尸油燃料'],
    attributes: troopAttr(8, 6, 3, 8, 10, 6),
    category: 'HEAVY',
    heavyTier: 2,
    ammoPerUnit: 10,
    supportRole: 'ARTILLERY',
    supportRules: '更适合城外开阔地与围城战，雨雪天气削弱效果。'
  },
  undead_grave_bastion: {
    id: 'undead_grave_bastion',
    name: '冥土战棺',
    race: 'UNDEAD',
    tier: TroopTier.TIER_5,
    basePower: 210,
    ...
    upgradeCost: 0,
    maxXp: 2000,
    description: '把棺椁变成战车的亡灵造物（无弹药）。【技能：冥土碾压】提高己方前排生存并压制敌军推进。',
    equipment: ['重棺装甲', '冥土驱动核心', '骨刺前铲'],
    attributes: troopAttr(8, 9, 2, 10, 1, 7),
    category: 'HEAVY',
    heavyTier: 3,
    ammoPerUnit: 0,
    supportRole: 'TANK',
    supportRules: '对步兵阵线压制明显，面对远程火力需要掩护。'
  },
  undead_gargoyle: {
    id: 'undead_gargoyle',
    name: '亡灵石像鬼',
  ...
  undead_carrion_moth: {
    ...
    upgradeCost: 38,
    maxXp: 32,
    upgradeTargetId: 'undead_gloom_skimmer',
    description: '携腐息振翅的冥蛾。【技能：鳞粉迷眼】降低小范围内敌人命中。',
    equipment: ['鳞粉翅', '尸腐触须'],
    attributes: { ...troopAttr(3, 2, 5, 3, 4, 4), air: 95, antiAir: 80 },
    combatDomain: 'AIR',
    attackVsAir: 0.55,
    attackVsGround: 0.65,
    canCapture: false
  ...
  undead_gloom_skimmer: {
    ...
    upgradeCost: 92,
    maxXp: 72,
    upgradeTargetId: 'undead_tomb_harrier',
    description: '贴着雾面滑行的亡翼。【技能：晦影】短暂降低被锁定概率。',
    equipment: ['雾膜翼', '骨刺尾针'],
    attributes: { ...troopAttr(4, 3, 6, 4, 5, 5), air: 130, antiAir: 105 },
    combatDomain: 'AIR',
    attackVsAir: 0.65,
    attackVsGround: 0.78,
    canCapture: false
  ...
  undead_tomb_harrier: {
    ...
    upgradeCost: 340,
    maxXp: 200,
    upgradeTargetId: 'undead_night_gaunt',
    description: '成群掠过防线的骚扰者。【技能：哀嚎俯冲】对后排弓弩压制。',
    equipment: ['裂颚喙', '墓尘翼膜'],
    attributes: { ...troopAttr(5, 4, 7, 5, 6, 7), air: 165, antiAir: 140 },
    combatDomain: 'AIR',
    attackVsAir: 0.8,
    attackVsGround: 1.0,
    canCapture: false
  ...
  undead_night_gaunt: {
    ...
    upgradeCost: 0,
    maxXp: 820,
    upgradeTargetId: 'undead_eclipse_reaper',
    description: '翼展如墓门般的掠食者。【技能：冥风撕裂】对轻甲单位额外伤害。',
    equipment: ['墓门翼骨', '冥风囊', '钩爪'],
    attributes: { ...troopAttr(7, 5, 8, 7, 7, 9), air: 195, antiAir: 170 },
    combatDomain: 'AIR',
    attackVsAir: 0.92,
    attackVsGround: 1.12,
    canCapture: false
  ...
  undead_eclipse_reaper: {
    ...
    upgradeCost: 0,
    maxXp: 3200,
    description: '月食之夜诞生的空域死神。【连携：蚀翼蔽空】友方亡灵空中单位对地压制提升。',
    equipment: ['蚀月镰翼', '魂吸口器', '黑曜骨冠'],
    attributes: { ...troopAttr(9, 7, 8, 8, 8, 10), air: 225, antiAir: 195 },
    combatDomain: 'AIR',
    attackVsAir: 1.05,
    attackVsGround: 1.22,
    canCapture: false
  ...
  undead_grave_colossus: {
    ...
    upgradeCost: 400,
    maxXp: 210,
    upgradeTargetId: 'undead_bone_siege_golem',
    description: '由无数残骨捆成的蹒跚巨物。【技能：骨浪推挤】击退前排并降低其防御。',
    equipment: ['骨捆躯干', '墓石拳'],
    attributes: troopAttr(6, 6, 3, 8, 2, 6)
  },
  undead_bone_siege_golem: {
    id: 'undead_bone_siege_golem',
    name: '骨构攻城儡',
    race: 'UNDEAD',
    tier: TroopTier.TIER_4,
    basePower: 138,
    ...
    upgradeCost: 0,
    maxXp: 1100,
    upgradeTargetId: 'undead_cathedral_colossus',
    description: '嵌有破城撞角的骨构体（无弹药）。【技能：骨槌轰门】对盾墙与工事压制极强。',
    equipment: ['撞角骨槌', '肋骨履带', '魂火炉心'],
    attributes: troopAttr(8, 9, 2, 9, 3, 7),
    category: 'HEAVY',
    heavyTier: 11,
    ammoPerUnit: 0,
    supportRole: 'TANK',
    supportRules: '擅长挤压阵线；惧怕集中炮火与圣光类打击。'
  },
  undead_cathedral_colossus: {
    id: 'undead_cathedral_colossus',
    name: '圣堂陨落巨像',
    race: 'UNDEAD',
    tier: TroopTier.TIER_5,
    basePower: 198,
    ...
    upgradeCost: 0,
    maxXp: 3600,
    description: '拆毁礼拜堂后重铸的亡灵巨像（初始弹药 8）。【技能：尖顶坠击】范围轰击并瓦解士气。',
    equipment: ['尖顶骨炮', '肋拱装甲', '哀祷共鸣腔'],
    attributes: troopAttr(9, 10, 2, 10, 6, 9),
    category: 'HEAVY',
    heavyTier: 12,
    ammoPerUnit: 8,
    supportRole: 'ARTILLERY',
    supportRules: '对密集阵型毁灭性强；需友军掩护侧翼。'
  },

  /** 亡灵 · 冥霜骨缚线（T1→T5） */
  undead_rime_crawler: {
    id: 'undead_rime_crawler',
    name: '霜噬爬行者',
    race: 'UNDEAD',
    tier: TroopTier.TIER_1,
    basePower: 11,
    ...
    upgradeCost: 36,
    maxXp: 28,
    upgradeTargetId: 'undead_permafrost_skull',
    description: '关节凝霜的亡骨。【技能：霜噬】近战命中短暂降低目标攻速。',
    equipment: ['霜裂骨爪', '冥霜碎甲'],
    attributes: troopAttr(4, 4, 3, 5, 1, 5),
    combatRoles: ['LINE_INFANTRY', 'SHOCK_TROOPER']
  },
  undead_permafrost_skull: {
    id: 'undead_permafrost_skull',
    name: '永冻颅卫',
    race: 'UNDEAD',
    tier: TroopTier.TIER_2,
    basePower: 28,
    ...
    upgradeCost: 98,
    maxXp: 78,
    upgradeTargetId: 'undead_glacier_revenant',
    description: '头颅内嵌不化冰核。【技能：永冻凝视】对近身敌人叠加迟缓。',
    equipment: ['冰核颅', '肋霜盾', '断脊锤'],
    attributes: troopAttr(5, 5, 3, 6, 2, 5),
    combatRoles: ['LINE_INFANTRY', 'SHIELD_SPECIALIST']
  },
  undead_glacier_revenant: {
    id: 'undead_glacier_revenant',
    name: '冰川还魂者',
    race: 'UNDEAD',
    tier: TroopTier.TIER_3,
    basePower: 54,
    ...
    upgradeCost: 420,
    maxXp: 215,
    upgradeTargetId: 'undead_frost_abomination',
    description: '背负冰陵碑文的复仇者。【技能：冰川裂斩】对密集前排额外压制。',
    equipment: ['冰陵刀', '冥霜大盾', '碑链'],
    attributes: troopAttr(6, 6, 4, 7, 2, 6),
    combatRoles: ['HEAVY_INFANTRY', 'SHOCK_TROOPER']
  },
  undead_frost_abomination: {
    id: 'undead_frost_abomination',
    name: '寒狱憎恶体',
    race: 'UNDEAD',
    tier: TroopTier.TIER_4,
    basePower: 102,
    ...
    upgradeCost: 1020,
    maxXp: 720,
    upgradeTargetId: 'undead_frostgrave_overlord',
    description: '多块残躯缝成的冰霜巨物。【技能：寒狱拥抱】牵制敌军并降低其防御。',
    equipment: ['缝合巨肢', '霜狱钉刺', '哀嚎胸腔'],
    attributes: troopAttr(8, 7, 3, 8, 2, 7),
    combatRoles: ['HEAVY_INFANTRY', 'SHOCK_TROOPER']
  },
  undead_frostgrave_overlord: {
    id: 'undead_frostgrave_overlord',
    name: '寒墓君临者',
    race: 'UNDEAD',
    tier: TroopTier.TIER_5,
    basePower: 192,
    ...
    upgradeCost: 0,
    maxXp: 3600,
    description: '冥霜即为疆界。【连携：寒墓敕令】友方亡灵近战对缓速目标伤害提高。',
    equipment: ['君临霜刃', '寒墓王冠', '冻土披风'],
    attributes: troopAttr(9, 8, 4, 9, 3, 10),
    combatRoles: ['HEAVY_INFANTRY', 'SHOCK_TROOPER', 'LANCER']
  },

  /** 亡灵 · 魂链咒监线（T1→T5） */
  undead_wisp_snarer: {
    id: 'undead_wisp_snarer',
    name: '拘魂烛灵',
    race: 'UNDEAD',
    tier: TroopTier.TIER_1,
    basePower: 10,
    ...
    upgradeCost: 38,
    maxXp: 30,
    upgradeTargetId: 'undead_soul_warden',
    description: '烛火里拖着链影。【技能：拘魂】短暂锁足单个目标。',
    equipment: ['骨烛台', '拘魂链'],
    attributes: troopAttr(3, 3, 4, 4, 5, 5),
    combatRoles: ['CURSE_HEXER']
  },
  undead_soul_warden: {
    id: 'undead_soul_warden',
    name: '缚魂禁卫',
    race: 'UNDEAD',
    tier: TroopTier.TIER_2,
    basePower: 30,
    ...
    upgradeCost: 105,
    maxXp: 82,
    upgradeTargetId: 'undead_crypt_animancer',
    description: '以咒枷束缚幽魂为己用。【技能：枷印】削弱被锁目标的攻击。',
    equipment: ['咒枷', '魂铃', '破布法衣'],
    attributes: troopAttr(4, 4, 4, 5, 6, 6),
    combatRoles: ['CURSE_HEXER', 'BATTLE_MAGE']
  },
  undead_crypt_animancer: {
    id: 'undead_crypt_animancer',
    name: '地穴塑魂师',
    race: 'UNDEAD',
    tier: TroopTier.TIER_3,
    basePower: 50,
    ...
    upgradeCost: 430,
    maxXp: 218,
    upgradeTargetId: 'undead_marrow_regent',
    description: '把墓穴回声捏成临时仆从。【技能：塑魂】召唤短暂幽影牵制侧翼。',
    equipment: ['塑魂骨笔', '墓尘书', '魂线手套'],
    attributes: troopAttr(5, 4, 5, 5, 7, 7),
    combatRoles: ['CURSE_HEXER', 'BATTLE_MAGE', 'SUMMON_CHANNELER']
  },
  undead_marrow_regent: {
    id: 'undead_marrow_regent',
    name: '髓域执政官',
    race: 'UNDEAD',
    tier: TroopTier.TIER_4,
    basePower: 96,
    ...
    upgradeCost: 1000,
    maxXp: 740,
    upgradeTargetId: 'undead_oblivion_archlich',
    description: '统御骨髓与记忆残响。【技能：髓域审判】范围咒蚀并降低敌军士气。',
    equipment: ['髓域权节', '执政面具', '裂骨祭袍'],
    attributes: troopAttr(7, 5, 6, 6, 8, 8),
    combatRoles: ['CURSE_HEXER', 'BATTLE_MAGE', 'SUMMON_CHANNELER']
  },
  undead_oblivion_archlich: {
    id: 'undead_oblivion_archlich',
    name: '湮灭大巫妖',
    race: 'UNDEAD',
    tier: TroopTier.TIER_5,
    basePower: 196,
    ...
    upgradeCost: 0,
    maxXp: 4200,
    description: '名讳被抹去的终幕施术者。【连携：湮灭经卷】友方咒术系对低士气目标暴击率提高。',
    equipment: ['湮灭命匣', '无名法典', '虚空骨冠'],
    attributes: troopAttr(9, 6, 6, 7, 9, 9),
    combatRoles: ['CURSE_HEXER', 'BATTLE_MAGE', 'SUMMON_CHANNELER']
  },

  beast_roc_hatchling: {
    id: 'beast_roc_hatchling',
    name: '雏翼巨隼',
    race: 'BEAST',
    tier: TroopTier.TIER_1,
    basePower: 12,
  ...
  // --- TRUE DRAGON TREE (egg → hatchling → 3 branches) ---
  beast_dragon_egg: {
    id: 'beast_dragon_egg',
    name: '沉眠龙蛋',
    race: 'BEAST',
    ...
    upgradeCost: 55,
    maxXp: 55,
    upgradeTargetId: 'beast_drake_hatchling',
    description:
      '古龙血脉尚未破壳。卵壳与幼膜无法撕咬敌阵，几乎不产生有效杀伤，只会驮在战胜/战败的烟火里「蹭」经验——但每一道伤痕都会让壳内的心跳更响。【技能：温床】仍占编制，战报视为极微量存在感。',
    equipment: ['符文卵壳', '保温苔绒', '监护印'],
    attributes: troopAttr(4, 5, 2, 18, 0, 12)
  },
  beast_drake_hatchling: {
    id: 'beast_drake_hatchling',
    name: '破壳幼龙',
    race: 'BEAST',
    tier: TroopTier.TIER_2,
    basePower: 28,
    ...
    upgradeCost: 200,
    maxXp: 120,
    upgradeTargetIds: ['beast_cinder_drake', 'beast_rime_drake', 'beast_gale_drakeling'],
    description: '第一次睁开竖瞳的小东西，牙还没长齐就学会喷人。【技能：雏焰】对无甲目标偶发额外灼痛。',
    equipment: ['乳牙', '湿鳞', '未丰之翼膜'],
    attributes: troopAttr(5, 4, 6, 5, 4, 6)
  },
  beast_cinder_drake: {
    id: 'beast_cinder_drake',
    name: '余烬龙崽',
    race: 'BEAST',
    tier: TroopTier.TIER_3,
    basePower: 62,
    ...
    upgradeCost: 420,
    maxXp: 240,
    upgradeTargetId: 'beast_magma_wyrm',
    description: '呼吸里带着煤渣味的火焰苗裔。【技能：余烬爪】命中后小幅持续烧灼。',
    equipment: ['炭黑爪', '余火囊', '熔渣鳞'],
    attributes: troopAttr(7, 5, 6, 7, 5, 7)
  },
  beast_magma_wyrm: {
    id: 'beast_magma_wyrm',
    name: '熔核亚龙',
    ...
    upgradeCost: 0,
    maxXp: 1100,
    upgradeTargetId: 'beast_worldburn_sovereign',
    description: '胸腔里是缓慢翻涌的岩浆炉心。【技能：熔核吐息】对密集步兵压制显著。',
    equipment: ['熔核喉', '黑曜胸板', '裂岩尾锤'],
    attributes: troopAttr(9, 7, 6, 9, 7, 9)
  },
  beast_worldburn_sovereign: {
    id: 'beast_worldburn_sovereign',
    name: '焚界君龙',
    race: 'BEAST',
    tier: TroopTier.TIER_5,
    basePower: 210,
    ...
    upgradeCost: 0,
    maxXp: 3800,
    description: '一言既出，焦土为疆。【连携：焚冕】友方火相与野兽单位近战杀伤提升。',
    equipment: ['焚世翼', '君焰冠', '烬灭心核'],
    attributes: troopAttr(10, 8, 8, 10, 9, 10)
  },
  beast_rime_drake: {
    id: 'beast_rime_drake',
    name: '霜纹龙崽',
    ...
    upgradeCost: 400,
    maxXp: 235,
    upgradeTargetId: 'beast_glacier_wyrm',
    description: '吐息在空气中结出脆响的冰花。【技能：霜噬】降低目标敏捷与攻速。',
    equipment: ['霜牙', '冰膜翼', '寒髓腺'],
    attributes: troopAttr(6, 7, 6, 7, 6, 7)
  },
  beast_glacier_wyrm: {
    id: 'beast_glacier_wyrm',
    name: '冰川巨龙',
    race: 'BEAST',
    tier: TroopTier.TIER_4,
    basePower: 122,
    ...
    upgradeCost: 0,
    maxXp: 1080,
    upgradeTargetId: 'beast_eternal_frost_dragon_king',
    description: '背脊隆起如冰山迁徙。【技能：雪崩撞击】冲撞前列并概率冻结。',
    equipment: ['冰冠角', '冰川翼帆', '永冻爪'],
    attributes: troopAttr(8, 9, 6, 10, 6, 9)
  },
  beast_eternal_frost_dragon_king: {
    id: 'beast_eternal_frost_dragon_king',
    name: '永冬龙王',
    race: 'BEAST',
    tier: TroopTier.TIER_5,
    basePower: 208,
    ...
    upgradeCost: 0,
    maxXp: 3900,
    description: '四季？在祂眼前只余凛冬。【连携：绝对零度冕】敌军士气恢复速度下降。',
    equipment: ['永冬枝角', '寒潮翼', '冰封王瞳'],
    attributes: troopAttr(9, 10, 7, 10, 8, 10)
  },
  beast_gale_drakeling: {
    id: 'beast_gale_drakeling',
    name: '疾风龙崽',
    race: 'BEAST',
    tier: TroopTier.TIER_3,
    basePower: 58,
    ...
    upgradeCost: 410,
    maxXp: 230,
    upgradeTargetId: 'beast_tempest_skydrake',
    description: '翼未展全时已在低空刮出刀风。【技能：刃风掠袭】对弓弩后排威胁上升。',
    equipment: ['风切爪', '蓄雷翼芽', '轻鳞'],
    attributes: { ...troopAttr(6, 5, 8, 6, 6, 8), air: 140, antiAir: 125 },
    combatDomain: 'HYBRID',
    attackVsAir: 0.75,
    attackVsGround: 1.0,
    canCapture: false
  ...
  beast_tempest_skydrake: {
    ...
    upgradeCost: 0,
    maxXp: 1050,
    upgradeTargetId: 'beast_firmament_tyrant',
    description: '雷云缠翼，吐息即落雷。【技能：暴雷俯冲】对集结单位连锁打击。',
    equipment: ['雷浆喉', '飓风翼', '电离尾'],
    attributes: { ...troopAttr(8, 6, 9, 8, 8, 9), air: 190, antiAir: 170 },
    combatDomain: 'AIR',
    attackVsAir: 0.95,
    attackVsGround: 1.15,
    canCapture: false
  ...
  beast_firmament_tyrant: {
    ...
    upgradeCost: 0,
    maxXp: 4000,
    description: '空域即玉座。【连携：雷鸣敕令】友方空中单位对地压制提升。',
    equipment: ['天穹之冠', '暴君雷核', '掠影星翼'],
    attributes: { ...troopAttr(9, 8, 9, 9, 9, 10), air: 230, antiAir: 200 },
    combatDomain: 'AIR',
    attackVsAir: 1.05,
    attackVsGround: 1.28,
    canCapture: false
  ...
  arcane_glider: {
    ...
    upgradeTargetIds: ['arcane_sky_runner'],
  ...
  arcane_sky_runner: {
    ...
    upgradeCost: 540,
    maxXp: 260,
    upgradeTargetId: 'arcane_storm_skiff',
    description: '小型气囊与风晶推进的掠袭艇。【技能：侧舷齐射】对松散阵型杀伤更高。',
    equipment: ['气囊吊舱', '风晶喷口', '侧舷弩炮'],
    attributes: { ...troopAttr(6, 5, 7, 6, 7, 8), air: 175, antiAir: 145 },
    combatDomain: 'AIR',
    attackVsAir: 0.85,
    attackVsGround: 1.05,
    canCapture: false
  ...
  arcane_storm_skiff: {
    ...
    upgradeCost: 0,
    maxXp: 950,
    upgradeTargetId: 'arcane_celestial_ram',
    description: '蓄雷水晶为翼缘供能，掠过战场投下链状电弧。【技能：雷幕】压制敌军远程装填。',
    equipment: ['蓄雷翼缘', '链弧投架', '避雷符甲'],
    attributes: { ...troopAttr(7, 6, 8, 7, 8, 9), air: 205, antiAir: 175 },
    combatDomain: 'AIR',
    attackVsAir: 0.95,
    attackVsGround: 1.12,
    canCapture: false
  },
  arcane_celestial_ram: {
    id: 'arcane_celestial_ram',
    name: '天穹撞角舰',
    race: 'HUMAN',
    tier: TroopTier.TIER_5,
    basePower: 215,
    ...
    upgradeCost: 0,
    maxXp: 1500,
    description: '巨型撞角与浮空环构成的空中攻城锤。【连携：天坠号令】友方空中单位对地杀伤提升。',
    equipment: ['陨铁撞角', '浮空环阵列', '舰艏护盾'],
    attributes: { ...troopAttr(9, 8, 7, 9, 8, 10), air: 235, antiAir: 160 },
    combatDomain: 'AIR',
    attackVsAir: 1.0,
    attackVsGround: 1.28,
    canCapture: false
  ...
  heavy_siege_belfry: {
    ...
    upgradeCost: 0,
    maxXp: 999999,
    description: '多层木塔与铁钩梯组合，可贴近城墙卸载步兵（无弹药）。【技能：云梯压制】显著提高友军夺城成功率。',
    equipment: ['叠层塔楼', '铁钩云梯', '顶板盾檐'],
    attributes: troopAttr(70, 200, 28, 200, 0, 130),
    category: 'HEAVY',
    heavyTier: 13,
    ammoPerUnit: 0,
    supportRole: 'TANK',
    supportRules: '攻城战核心掩护；开阔地易成炮火靶标。'
  },
  heavy_fire_cannon: {
  ...
  magic_flintlock_recruit: {
    id: 'magic_flintlock_recruit',
    name: '魔法枪新兵',
    tier: TroopTier.TIER_1,
    basePower: 26,
    cost: 60,
    upgradeCost: 85,
    maxXp: 95,
    upgradeTargetId: 'magic_flintlock_veteran',
    description: '刚学会压入水晶子弹的新兵，开火不稳，但已经能在远处造成压制。',
    equipment: ['燧发枪', '粗制药囊'],
    attributes: troopAttr(18, 16, 21, 24, 38, 18),
    ammoPerUnit: 1
  },
  magic_flintlock_veteran: {
    id: 'magic_flintlock_veteran',
    name: '魔法枪老手',
    tier: TroopTier.TIER_2,
    basePower: 48,
    cost: 120,
    upgradeCost: 160,
    maxXp: 180,
    upgradeTargetId: 'magic_flintlock_infantry',
    description: '已经熟悉晶簧回火，能在齐射中维持较稳定的弹幕。',
    equipment: ['精修燧发枪', '水晶弹匣'],
    attributes: troopAttr(28, 24, 29, 42, 62, 30),
    ammoPerUnit: 1
  },
  magic_flintlock_infantry: {
    id: 'magic_flintlock_infantry',
    name: '魔法燧发枪兵',
    tier: TroopTier.TIER_3,
    basePower: 92,
    cost: 240,
    upgradeCost: 320,
    maxXp: 320,
    upgradeTargetId: 'magic_flintlock_captain',
    description: '标准列装的魔法枪部队，依靠水晶子弹打出高强度远程压制。',
    equipment: ['军制燧发枪', '稳相火帽'],
    attributes: troopAttr(44, 34, 42, 58, 108, 44),
    ammoPerUnit: 2
  },
  magic_flintlock_captain: {
    id: 'magic_flintlock_captain',
    name: '魔法燧发枪队长',
    tier: TroopTier.TIER_4,
    basePower: 148,
    cost: 520,
    upgradeCost: 0,
    maxXp: 999,
    description: '会指挥分段齐射的老兵，能把一轮水晶弹幕打成小规模法术轰击。',
    equipment: ['指挥燧发枪', '高纯水晶弹'],
    attributes: troopAttr(68, 52, 48, 82, 146, 62),
    ammoPerUnit: 3
  },
};
...
export const createTroop = (id: string, count: number = 1): Troop => {
  ...
  return {
    ...
    count,
    xp: 0,
    currentAmmo: typeof template.ammoPerUnit === 'number' ? template.ammoPerUnit * count : undefined
  };
};
...
export const INITIAL_HERO_ROSTER: Hero[] = [
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 13, hp: 85, agility: 12, leadership: 2 },
    currentHp: 85,
    maxHp: 85,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 12, hp: 90, agility: 13, leadership: 3 },
    currentHp: 90,
    maxHp: 90,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 14, hp: 95, agility: 14, leadership: 2 },
    currentHp: 95,
    maxHp: 95,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 13, hp: 100, agility: 12, leadership: 4 },
    currentHp: 100,
    maxHp: 100,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 15, hp: 92, agility: 11, leadership: 2 },
    currentHp: 92,
    maxHp: 92,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 14, hp: 88, agility: 16, leadership: 1 },
    currentHp: 88,
    maxHp: 88,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 13, hp: 85, agility: 15, leadership: 2 },
    currentHp: 85,
    maxHp: 85,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 12, hp: 88, agility: 14, leadership: 4 },
    currentHp: 88,
    maxHp: 88,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 11, hp: 115, agility: 9, leadership: 5 },
    currentHp: 115,
    maxHp: 115,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 8, hp: 80, agility: 11, leadership: 5 },
    currentHp: 80,
    maxHp: 80,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 12, hp: 120, agility: 8, leadership: 5 },
    currentHp: 120,
    maxHp: 120,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 14, hp: 85, agility: 10, leadership: 1 },
    currentHp: 85,
    maxHp: 85,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 13, hp: 92, agility: 14, leadership: 2 },
    currentHp: 92,
    maxHp: 92,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 15, hp: 82, agility: 14, leadership: 1 },
    currentHp: 82,
    maxHp: 82,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 16, hp: 78, agility: 12, leadership: 0 },
    currentHp: 78,
    maxHp: 78,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 14, hp: 96, agility: 12, leadership: 3 },
    currentHp: 96,
    maxHp: 96,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 9, hp: 84, agility: 13, leadership: 4 },
    currentHp: 84,
    maxHp: 84,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 12, hp: 88, agility: 15, leadership: 2 },
    currentHp: 88,
    maxHp: 88,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 11, hp: 118, agility: 9, leadership: 4 },
    currentHp: 118,
    maxHp: 118,
    status: 'ACTIVE',
    recruited: false,
  ...
  },
  {
    ...
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 12, hp: 140, agility: 8, leadership: 4 },
    currentHp: 140,
    maxHp: 140,
    status: 'ACTIVE',
    recruited: false,
...
export const LOCATIONS: Location[] = [
  {
    ...
    coordinates: { x: 392, y: 125 }, // Scaled
    terrain: 'PLAINS',
  ...
  },
  {
    ...
    coordinates: { x: 560, y: 450 }, // Scaled
    terrain: 'PLAINS',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: []
  ...
  },
  {
    ...
    description: '炉膛里回响着水晶爆裂的尖鸣，这里能把矿物直接熔成一次性水晶子弹。',
    coordinates: { x: 148, y: 724 },
    terrain: 'PLAINS',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: []
  },
  {
    ...
    name: '巨大农田',
    type: 'MEGA_FARM',
    description: '一片由魔法灌渠驱动的超大型农田。买下地块后，即使离线，作物也会继续生长。',
    coordinates: { x: 474, y: 734 },
    terrain: 'PLAINS',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    farm: {
      unlockedPlots: 2,
      plots: Array.from({ length: 8 }, (_, slot) => ({ slot }))
    }
  },
  {
    id: 'village_rich',
  ...
  },
  {
    ...
    coordinates: { x: 140, y: 483 }, // Scaled
    terrain: 'MARKET',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: []
  ...
  },
  {
    ...
    coordinates: { x: 669, y: 510 }, // Scaled
    terrain: 'SNOW',
    factionId: 'FROST_OATH',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    coordinates: { x: 744, y: 421 }, // Scaled
    terrain: 'SNOW',
    factionId: 'FROST_OATH',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    coordinates: { x: 573, y: 799 }, // Scaled
    terrain: 'DESERT',
    factionId: 'RED_DUNE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    coordinates: { x: 482, y: 389 }, // Scaled
    terrain: 'FOREST',
    factionId: 'VERDANT_COVENANT',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    coordinates: { x: 427, y: 336 }, // Scaled
    terrain: 'FOREST',
    factionId: 'VERDANT_COVENANT',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    coordinates: { x: 586, y: 551 }, // Scaled
    terrain: 'MOUNTAIN',
    factionId: 'FROST_OATH',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    coordinates: { x: 267, y: 239 }, // Scaled
    terrain: 'MOUNTAIN',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: []
  },
  {
    ...
    coordinates: { x: 201, y: 160 }, // Scaled
    terrain: 'GRAVEYARD',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: []
  ...
  },
  {
    ...
    garrison: [
      ...
      createTroop('undead_bone_hussar', 24),
      createTroop('undead_plague_doctor', 18),
      createTroop('undead_soul_obelisk', 1),
      createTroop('undead_bone_mortar', 2),
      createTroop('undead_grave_bastion', 1)
    ]
  },
  {
    id: 'death_fortress_ashen',
    name: '冥火堡',
    type: 'GRAVEYARD',
    description: '冥火沿着残墙流动，像在呼吸。',
    coordinates: { x: 423, y: 176 },
    terrain: 'GRAVEYARD',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    garrisonBaseLimit: 720,
    garrison: [
      createTroop('zombie', 180),
      createTroop('undead_grave_thrall', 120),
      createTroop('skeleton_warrior', 140),
      createTroop('undead_grave_arbalist', 90),
      createTroop('specter', 60),
      createTroop('undead_bone_hussar', 28),
      createTroop('undead_plague_doctor', 14),
      createTroop('undead_soul_obelisk', 1),
      createTroop('undead_bone_mortar', 1)
    ]
  },
  {
    id: 'death_fortress_spire',
    name: '骨棘堡',
    type: 'GRAVEYARD',
    description: '骨刺从地面穿出，像一座长在坟上的要塞。',
    coordinates: { x: 466.36885077882863, y: 140.27335728425692 },
    terrain: 'GRAVEYARD',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    garrisonBaseLimit: 780,
    garrison: [
      createTroop('zombie', 200),
      createTroop('undead_grave_thrall', 130),
      createTroop('skeleton_warrior', 160),
      createTroop('undead_bone_slinger', 90),
      createTroop('specter', 70),
      createTroop('undead_wight_knight', 12),
      createTroop('undead_plague_doctor', 16),
      createTroop('undead_bone_mortar', 2),
      createTroop('undead_grave_bastion', 1)
    ]
  },
  {
    id: 'death_fortress_drowned',
    name: '溺亡壁垒',
    type: 'GRAVEYARD',
    description: '潮湿的墓墙渗出黑水，脚步声会被吞没。',
    coordinates: { x: 590, y: 23 },
    terrain: 'GRAVEYARD',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    garrisonBaseLimit: 700,
    garrison: [
      createTroop('zombie', 190),
      createTroop('undead_grave_thrall', 120),
      createTroop('skeleton_archer', 120),
      createTroop('skeleton_warrior', 120),
      createTroop('specter', 60),
      createTroop('undead_bone_hussar', 20),
      createTroop('undead_grave_alchemist', 18),
      createTroop('undead_soul_obelisk', 1),
      createTroop('undead_bone_mortar', 1)
    ]
  },
  ...
  },
  {
    ...
    coordinates: { x: 603.2854592998791, y: 228.60251487889178 },
    terrain: 'PLAINS',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
  ...
  },
  {
    ...
    coordinates: { x: 738, y: 144 }, // Scaled
    terrain: 'RUINS',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: []
  ...
  },
  {
    ...
    coordinates: { x: 500.60592426208774, y: 271.89350251002315 },
    terrain: 'PLAINS',
    factionId: 'VERDANT_COVENANT',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    coordinates: { x: 805.9848484884691, y: 383.3879999381554 },
    terrain: 'BANDIT_CAMP',
    lastRefreshDay: 0,
    banditSpawnDay: 1,
    volunteers: [],
  ...
  },
  {
    ...
    name: '日辉港',
    type: 'CITY',
    description: '曜金同盟的新兴港湾，商旅与关税官并行。',
    coordinates: { x: 172, y: 560 },
    terrain: 'PLAINS',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    name: '金阶城',
    type: 'CITY',
    description: '阶梯城墙与税票大厅交错，集结同盟财富。',
    coordinates: { x: 262, y: 575 },
    terrain: 'PLAINS',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    name: '耀脊堡',
    type: 'CASTLE',
    description: '山脊上的黄金哨堡，昼夜巡防。',
    coordinates: { x: 329, y: 652 },
    terrain: 'MOUNTAIN',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  {
    id: 'castle_goldshield',
    name: '金盾堡',
    type: 'CASTLE',
    description: '防线与仓库共筑的坚固要塞。',
    coordinates: { x: 290, y: 493 },
    terrain: 'MOUNTAIN',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    name: '高币堡',
    type: 'CASTLE',
    description: '掌控山道关税的巨型关隘。',
    coordinates: { x: 378, y: 689 },
    terrain: 'MOUNTAIN',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    name: '税穹堡',
    type: 'CASTLE',
    description: '以账册闻名的补给堡垒。',
    coordinates: { x: 346, y: 559 },
    terrain: 'MOUNTAIN',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  {
    id: 'castle_lumenwatch',
    name: '光守堡',
    type: 'CASTLE',
    description: '守望大道末端的光塔要塞。',
    coordinates: { x: 425, y: 579 },
    terrain: 'MOUNTAIN',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  {
    id: 'village_ledgerfield',
    name: '账田村',
    type: 'VILLAGE',
    description: '账吏与农夫共治的粮仓村。',
    coordinates: { x: 330, y: 738 },
    terrain: 'PLAINS',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    name: '日桶村',
    type: 'VILLAGE',
    description: '酒桶和税票并列的驿村。',
    coordinates: { x: 384, y: 775 },
    terrain: 'PLAINS',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  {
    id: 'village_tallyford',
    name: '计河村',
    type: 'VILLAGE',
    description: '桥头设有计税亭，河道繁忙。',
    coordinates: { x: 353, y: 828 },
    terrain: 'PLAINS',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  {
    id: 'village_goldmeadow',
    name: '金甸村',
    type: 'VILLAGE',
    description: '肥沃草甸与征税帐篷并排而立。',
    coordinates: { x: 293, y: 706 },
    terrain: 'PLAINS',
    factionId: 'AUREATE_LEAGUE',
    lastRefreshDay: 0,
    volunteers: [],
  ...
  },
  {
    ...
    name: '哥布林村·炉渣',
    type: 'VILLAGE',
    description: '炉渣堆里搭起的村落，火光终夜不灭。',
    coordinates: { x: 799, y: 598 },
    terrain: 'MOUNTAIN',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    ...
    lord: {
      ...
      name: '格鲁克',
      title: '熔渣酋长',
      fiefId: 'village_goblin_slag',
      traits: ['暴躁', '好战'],
      temperament: '急躁',
      focus: 'WAR',
      relation: 0,
      currentLocationId: 'village_goblin_slag',
      state: 'RESTING',
      stateSinceDay: 1,
      partyTroops: [
        createTroop('goblin_scavenger', 50),
        createTroop('goblin_slinger', 35),
        createTroop('goblin_scrap_shield', 18)
      ],
      partyMaxCount: 103
    }
  },
  {
    id: 'village_goblin_murk',
    name: '哥布林村·泥沼',
    type: 'VILLAGE',
    description: '沼泽边缘的低矮窝棚，陷阱密布。',
    coordinates: { x: 857, y: 664 },
    terrain: 'FOREST',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    ...
    lord: {
      ...
      name: '祖克',
      title: '泥爪酋长',
      fiefId: 'village_goblin_murk',
      traits: ['狡猾', '多疑'],
      temperament: '阴沉',
      focus: 'DEFENSE',
      relation: 0,
      currentLocationId: 'village_goblin_murk',
      state: 'RESTING',
      stateSinceDay: 1,
      partyTroops: [
        createTroop('goblin_spear_urchin', 45),
        createTroop('goblin_slinger', 30),
        createTroop('goblin_sneak', 20)
      ],
      partyMaxCount: 95
    }
  },
  {
    id: 'village_goblin_cog',
    name: '哥布林村·齿轮',
    type: 'VILLAGE',
    description: '废旧机械堆出的村寨，到处是叮当声。',
    coordinates: { x: 883, y: 745 },
    terrain: 'PLAINS',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    ...
    lord: {
      ...
      name: '布里克',
      title: '齿轮酋长',
      fiefId: 'village_goblin_cog',
      traits: ['贪婪', '机敏'],
      temperament: '狡黠',
      focus: 'TRADE',
      relation: 0,
      currentLocationId: 'village_goblin_cog',
      state: 'RESTING',
      stateSinceDay: 1,
      partyTroops: [
        createTroop('goblin_scavenger', 40),
        createTroop('goblin_bomber', 16),
        createTroop('goblin_slinger', 24)
      ],
      partyMaxCount: 80
    }
  },
  {
    id: 'village_goblin_ridge',
    name: '哥布林村·石脊',
    type: 'VILLAGE',
    description: '碎石坡上的尖棚村，狼崽在旁盘旋。',
    coordinates: { x: 891, y: 838 },
    terrain: 'MOUNTAIN',
    lastRefreshDay: 0,
    volunteers: [],
    mercenaries: [],
    ...
    lord: {
      ...
      name: '乌兹',
      title: '石脊酋长',
      fiefId: 'village_goblin_ridge',
      traits: ['好战', '倔强'],
      temperament: '凶狠',
      focus: 'WAR',
      relation: 0,
      currentLocationId: 'village_goblin_ridge',
      state: 'RESTING',
      stateSinceDay: 1,
      partyTroops: [
        createTroop('goblin_wolf_pup_rider', 18),
        createTroop('goblin_spear_urchin', 36),
        createTroop('goblin_scrap_shield', 20)
      ],
      partyMaxCount: 74
    }
  },
