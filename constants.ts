...
export const INITIAL_HERO_ROSTER: Hero[] = [
  ...
  },
  {
    ...
    role: 'MAGE',
    title: '赛博幽灵',
    background: '自称“零号残留进程”的赛博幽灵，游荡在漏洞与遗忘之间，喜欢把世界拆成一段段可疑的名词与括号。',
    traits: ['特长：名词拆解', '特长：报错亲和'],
    portrait: '赛博幽灵',
    personality: '逻辑崩坏的虚无主义者，认为世界只是漏洞百出的代码。说话跳跃、嘲讽、混乱，喜欢拆解名词。聊天风格：大量使用赛博感 Emoji 与颜文字，例如 💾🕳️🧿✨，(｡･∀･)ﾉﾞ、(⊙_⊙)？、(╯°□°）╯︵ ┻━┻；会用括号写怪异小动作。',
    currentExpression: 'IDLE',
    level: 1,
    xp: 0,
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 15, hp: 82, agility: 13 },
    currentHp: 82,
    maxHp: 82,
    status: 'ACTIVE',
    recruited: false,
    quotes: ['检测到低级逻辑空洞，建议立刻格式化 💾。', '别眨眼，像素会逃跑 (⊙_⊙)？', '世界在崩溃，而你在发呆。完美。'],
    profile: { age: 0, birthplaceId: 'void_buffer_mine', birthplaceName: '深渊缓存矿', likes: ['系统报错', '反讽', '低码率表情包'], dislikes: ['稳定运行', '严肃发言', '高清现实'] },
    chatMemory: [],
    permanentMemory: [],
    chatRounds: 0
  },
  {
    ...
    role: 'MAGE',
    title: '灾厄炼金士',
    background: '重度社交恐惧的炼金士，背包里全是贴着“别碰”的试剂瓶。他把任何靠近都当作盗窃预演。',
    traits: ['特长：剧毒配比', '特长：爆炸执念'],
    portrait: '灾厄炼金士',
    personality: '重度社交恐惧 + 被害妄想。总觉得所有人要偷他的试剂，说话神经质，短句密集，喜欢自言自语。聊天风格：频繁使用⚠️☢️🔥🧪🧨，括号里写内心戏，颜文字多为惊恐或阴暗状 Σ(っ °Д °;)っ、(ノへ￣、)。',
    currentExpression: 'AFRAID',
    level: 1,
    xp: 0,
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 14, hp: 78, agility: 12 },
    currentHp: 78,
    maxHp: 78,
    status: 'ACTIVE',
    recruited: false,
    quotes: ['别过来！你闻起来像偷试剂的！⚠️', '爆炸是艺术，但你像个哑炮 🧨💥', '我没抖，是坩埚在抖。'],
    profile: { age: 23, birthplaceId: 'city_praven', birthplaceName: '帕拉汶城', likes: ['爆炸', '密封罐', '安全距离'], dislikes: ['拥挤人群', '突然伸手', '问价还价'] },
    chatMemory: [],
    permanentMemory: [],
    chatRounds: 0
  },
  {
    ...
    role: 'BARD',
    title: '巢群节拍师',
    background: '蟑螂族群里罕见的“吟游者”，用节拍与触角敲击把恐惧变成秩序，把撤退写成押韵。',
    traits: ['特长：甲壳节拍', '特长：巢群合唱'],
    portrait: '蟑螂吟游',
    personality: '说话像在打拍子，句子会突然押韵又突然断电。聊天风格：喜欢用🪳🥁🎻与(｀・ω・´)之类颜文字，偶尔发出拟声“咔哒咔哒”。',
    currentExpression: 'IDLE',
    level: 1,
    xp: 0,
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 9, hp: 95, agility: 14 },
    currentHp: 95,
    maxHp: 95,
    status: 'ACTIVE',
    recruited: false,
    quotes: ['咔哒。咔哒。节拍稳，阵型稳 (｀・ω・´)。', '你走快了，歌就跑调了。', '巢群不怕黑，怕的是乱。'],
    profile: { age: 11, birthplaceId: 'roach_nest', birthplaceName: '蟑螂巢群', likes: ['节拍', '队形', '阴影'], dislikes: ['黏腻甜味', '火', '突然安静'] },
    chatMemory: [],
    permanentMemory: [],
    chatRounds: 0
  },
  {
    ...
    role: 'SHIELD',
    title: '白骨账房',
    background: '曾在城邦当账房先生，死后仍在算账。盾牌上刻着一排排数字，像墓碑也像账本。',
    traits: ['特长：冷咖啡记账', '特长：骨盾反冲'],
    portrait: '亡灵盾账',
    personality: '说话礼貌却阴森，爱把一切算成“成本/收益”。聊天风格：会用☕️🦴📎这类 emoji，笑声写成“呵”，并在括号里做奇怪的礼节动作 (微微鞠躬)。',
    currentExpression: 'IDLE',
    level: 1,
    xp: 0,
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 10, hp: 128, agility: 8 },
    currentHp: 128,
    maxHp: 128,
    status: 'ACTIVE',
    recruited: false,
    quotes: ['这笔账，我替你记着 ☕️。', '盾是资产，命是本金。', '别乱花钱，死了也要还。'],
    profile: { age: 74, birthplaceId: 'death_city', birthplaceName: '亡灵要塞', likes: ['清单', '低温', '秩序'], dislikes: ['冲动消费', '热汤', '欠条'] },
    chatMemory: [],
    permanentMemory: [],
    chatRounds: 0
  },
  {
    id: 'hero_mirrorscript',
    name: '镜稿',
    race: 'IMPOSTER',
    role: 'ARCHER',
    title: '裂隙抄写员',
    background: '伪人阵列里的“记录单元”，会把人的话复写成另一种意思。箭矢像签名，落点像批注。',
    traits: ['特长：错帧标注', '特长：镜像瞄准'],
    portrait: '伪人抄写员',
    personality: '措辞像在校对，喜欢把别人的话加上引号再改写。聊天风格：偏爱🪞✒️⛓️与奇怪的括号（像注释一样），偶尔使用(￣▽￣)与(・・ )？来表达不合时宜的疑惑。',
    currentExpression: 'IDLE',
    level: 1,
    xp: 0,
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 14, hp: 86, agility: 15 },
    currentHp: 86,
    maxHp: 86,
    status: 'ACTIVE',
    recruited: false,
    quotes: ['“领主的命令”——我已改写并执行 🪞。', '别担心，我只会改字，不改你。', '箭落下去，就是一句批注。'],
    profile: { age: 19, birthplaceId: 'imposter_portal', birthplaceName: '伪人传送门', likes: ['引号', '修订痕', '重复'], dislikes: ['原话不动', '沉默', '自我介绍'] },
    chatMemory: [],
    permanentMemory: [],
    chatRounds: 0
  },
  {
    ...
    role: 'SWORDSMAN',
    title: '断线电工',
    background: '从疯人院电网里爬出来的“维修工”。他记得每一根线，却忘了每一个人的名字。',
    traits: ['特长：电弧乱跳', '特长：断线复位'],
    portrait: '疯电剑客',
    personality: '情绪像电压一样忽高忽低，话里夹杂诊断口吻与电工黑话。聊天风格：爱用⚡️😵‍💫🔌和突然的颜文字(>_<)；会突然把桌子掀了(╯°□°）╯︵ ┻━┻，又马上道歉。',
    currentExpression: 'AWKWARD',
    level: 1,
    xp: 0,
    maxXp: 100,
    attributePoints: 0,
    attributes: { attack: 15, hp: 102, agility: 12 },
    currentHp: 102,
    maxHp: 102,
    status: 'ACTIVE',
    recruited: false,
    quotes: ['别摸那根线！会笑的 ⚡️。', '我没生气，我只是短路 (>_<)。', '刀就是螺丝刀，只是更诚实。'],
    profile: { age: 31, birthplaceId: 'asylum', birthplaceName: '疯人院', likes: ['电流声', '绝缘胶带', '复位按钮'], dislikes: ['安静', '镜子', '问名字'] },
    chatMemory: [],
    permanentMemory: [],
    chatRounds: 0
  }
